...
static const struct voltage_map_desc boost_voltage_map_desc = {
	.min = 3700,	.max = 5200,	.step = 100,	.n_bits = 4,
};
...
static const struct voltage_map_desc *reg_voltage_map[] = {
	...
	[MAX8997_BOOST] = &boost_voltage_map_desc,
};
...
static __devinit int max8997_pmic_probe(struct platform_device *pdev)
{
	...
	max8997_write_reg(i2c,0x50,0x24);
	max8997_write_reg(i2c,0x51,0x14);
	//BUCK 6: added by yulu
	max8997_write_reg(i2c,MAX8997_REG_BUCK6CTRL + 1,0x43);
	max8997_read_reg(i2c,MAX8997_REG_BUCK6CTRL,&val);
	val |= 0x2;//hw pin --> ENBUCK 6 bit control
	max8997_write_reg(i2c,MAX8997_REG_BUCK6CTRL,val);
	//VDD_50
	max8997_write_reg(i2c,MAX8997_REG_BOOST_CNTL,0x1D);	
	max8997_read_reg(i2c,MAX8997_REG_BOOST_CNTL,&val);
	val |= 0x40;
	max8997_write_reg(i2c,MAX8997_REG_BOOST_CNTL,val);
